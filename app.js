    ...
    return `
      <article class="slip jawi">
        <div class="slip-header text-center">
          <img src="${CONFIG.crestUrl}" alt="Lencana KAFA An Nur">
        ...
        <table class="slip-info-table">
          <tbody>
            <tr>
              ...
              <td><span>كلاس</span><strong>${toJawi(className)}</strong></td>
...
function printReport() {
  ...
  printWindow.document.write(`
    ...
    <head>
      ...
      <title>Laporan KAFA An Nur</title>
      <style>
        * { box-sizing: border-box; }
        ...
        .jawi { direction: rtl; text-align: right; font-family: "Geeza Pro", "Al Bayan", serif; }
